            ...
            <div className='container flex justify-between items-center'>
                <div className=''>
                    <ul className='text-textColor flex gap-8 '>
                        ...
                        <li>Blog</li>
                        <li>Pages</li>
                        <li className='flex'>About <MdKeyboardArrowDown  className='self-center ' /> </li>
                        <li>Shop</li>
                        <li>Contact</li>
                    </ul>
                </div>
                <div className='flex gap-2'>
                    <div className={`${inter.className} flex border-[1px] rounded-[27px] border-primary3 py-[14px] px-[26px]`}>
