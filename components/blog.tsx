        ...
        <div className="my-[120px]">
            ...
            <div className="flex gap-6 justify-center">
                <BlogCard
                    ...
                    details="Pellentesque Non Efficitur Mi Aliquam Convallis Mi Quis"
                />
                <BlogCard
                    image="/assets/pizza.svg"
                    date="10 February 2022"
                    details="Morbi Sodales Tellus Elit, In Blandit Risus Suscipit A"
                />
                <BlogCard
                    image="/assets/wraps.svg"
                    date="10 February 2022"
                    details="Curabitur rutrum velit ac congue malesuada"
                />
            </div>
        </div>
    );
