...
function BlogCard({ image, date, details }: blogProps) {
    return (
        <div
            className={`${inter.className} text-textColor border-[1px] w-1/5 rounded-xl relative z-0 transition-all duration-300 hover:scale-110  shadow-[0px_10px_15px_-3px_rgba(231,_215,_157,_0.15)] border-textColor`}
        >
            <div>
